...
Pickup: `Follow AGENTS.md. Let's move to step 4.2.1` — then only the files that row lists. `4.2` is the umbrella (do not implement it as one step).
...
| 4.2 | `todo` | [Redis umbrella](4.02-redis.md) |
| 4.2.1 | `todo` | [Redis foundation + adapter](4.02.1-redis-foundation.md) |
| 4.2.2 | `todo` | [Redis cutover](4.02.2-redis-cutover.md) |
